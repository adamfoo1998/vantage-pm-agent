...
## Input contract
- **Screenshots**: `.Codex/reporting/<report-name>/<period>/` — the current period's PowerBI (or
  other dashboard) images.
- **Template**: `.Codex/reporting/<report-name>/templates/` — Adam supplies this per report; it
...
Adam onboards a new report by creating `.Codex/reporting/<report-name>/templates/` with the
template and dropping the first period's screenshots into `.Codex/reporting/<report-name>/<first-period>/`.
